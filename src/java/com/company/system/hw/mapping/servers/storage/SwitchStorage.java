...
/**
 * The <code>SwitchStorage</code> class for System Storage servers. 
 ...
 */
@Entity
@Table(name = "SWITCHSTORAGE")
public class SwitchStorage extends SystemStorage implements PhysicalRackServerInterface {
     ...
     * @param mgmtIP 
     */
    public SwitchStorage(Integer id, PhysicalProperties physicalServer, MM mgmtIP) {
        super();
        this.id = id;
